...
namespace UnityEngine.XR.iOS
{
	public class UnityARUtility
	{
		...
		public static GameObject UpdatePlaneWithAnchorTransform(GameObject plane, ARPlaneAnchor arPlaneAnchor)
		{
            ...
            BoxCollider physicalCollider = plane.GetComponentInChildren<BoxCollider>();
			...
			if (mf != null) {
				if (apmr == null) {
                    ...
                    physicalCollider.gameObject.transform.localScale = new Vector3(arPlaneAnchor.extent.x * 0.1f, arPlaneAnchor.extent.y * 0.1f, arPlaneAnchor.extent.z * 0.1f);
                    ...
                    physicalCollider.gameObject.transform.localPosition = new Vector3(arPlaneAnchor.extent.x * 0.1f, arPlaneAnchor.extent.y * 0.1f, arPlaneAnchor.extent.z * 0.1f);
				}
